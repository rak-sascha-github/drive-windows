...
/// <summary>
///     Provides an asynchronous implementation of an auto-reset event.
///     This class can be used to perform thread synchronization, allowing
///     asynchronous waiting and signaling similar to a traditional AutoResetEvent.
/// </summary>
public sealed class AutoResetEventAsync : IDisposable
{
	...
	public async ValueTask WaitAsync()
	{
		...
		lock (Q)
		{
			Q.Enqueue(s = new SemaphoreSlim(0, 1));
		}
	...
	///     The number of milliseconds to wait, <see cref="System.Threading.Timeout.Infinite" />
	///     (-1) to wait indefinitely, or zero to return immediately.
	/// </param>
	...
	///     that represents 0 milliseconds to return immediately.
	/// </param>
	/// <returns>Task completed when the event is signaled or the time runs out.</returns>
