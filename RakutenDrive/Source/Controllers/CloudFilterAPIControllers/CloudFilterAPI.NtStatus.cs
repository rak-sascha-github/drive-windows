...
public partial class CloudFilterAPI
{
	...
	/// <summary>
	///     Represents the various facilities used in NT status codes to categorize system errors or events.
	///     Facilities are used to group related error codes and aid in identifying their source or context.
	/// </summary>
	...
	/// <summary>
	///     Represents the severity level of an NT status code.
	/// </summary>
